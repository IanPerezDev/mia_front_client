        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div className="space-y-3">
                        <div className="flex flex-col">
                            <span className="text-sm font-medium text-gray-500">ID Reservación</span>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-gray-900">{reservation.confirmation_code}</span>
                        </div>
                        <div className="flex flex-col">
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <div className="flex flex-col">
                            <span className="text-sm font-medium text-gray-500">ID Servicio</span>
                            <span className="text-gray-900">{reservation.id_servicio}</span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-medium text-gray-500">ID Viajero</span>
